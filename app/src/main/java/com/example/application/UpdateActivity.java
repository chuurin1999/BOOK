...
public class UpdateActivity extends AppCompatActivity {
    ...
    String id, date, money, caption,spinner,spinner2,note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                spinner =sp.getSelectedItem().toString().trim();
                spinner2 = sp2.getSelectedItem().toString().trim();
                note = note_input.getText().toString().trim();
                myDB.updateData(id, date, money,caption,spinner,spinner2,note);
            }
        });
    ...
    void getAndSetIntentData(){
        if(getIntent().hasExtra("id") && getIntent().hasExtra("date") &&
                ...
                && getIntent().hasExtra("spinner") && getIntent().hasExtra("sinner2") && getIntent().hasExtra("note")){
